...
public class Kiosk {
    public void start() {
        ...
        List<MenuItem> burgerMenuItems = new ArrayList<>(List.of(
        ...
        List<MenuItem> drinksMenuItems = new ArrayList<>(List.of(
        ...
        List<MenuItem> dessertMenuItems = new ArrayList<>(List.of(
        ...
        // Burgers 카테고리 생성
        Menu burgersMenu = new Menu("Burgers", burgerMenuItems);
        ...
        // Desserts 카테고리 생성
        Menu dessertsMenu = new Menu("Desserts", dessertMenuItems);
        ...
        while (mainIdx != 0) {
            ...
            try {
                ...
                // 메인 메뉴 번호 선택
                mainIdx = scanner.nextInt();
                System.out.println();

                // 메인 메뉴에서 mainIdx에 0이 입력될 경우 반복문 종료
                if (mainIdx == 0) {
                ...
                // 버거 메뉴 선택
                    ...
                    Burger.printBurgersMenu(burgersMenu);

                    // 버거 메뉴 번호 선택
                    subIdx = scanner.nextInt();

                    // 버거 메뉴 선택에 따라 처리 (Burger 클래스 메서드 호출)
                    burger.selectMenu(subIdx, burgerMenuItems);
                }
                ...
                // 음료 메뉴 선택
                    ...
                    drink.selectMenu(subIdx, drinksMenuItems);
                }
                ...
                // 디저트 메뉴 선택
                    ...
                    dessert.selectMenu(subIdx, dessertMenuItems);

                    // mainIdx에 0-3 숫자가 아닌 다른 숫자가 입력될 경우 예외 처리
                } else {
